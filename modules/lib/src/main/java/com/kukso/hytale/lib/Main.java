package com.kukso.hytale.lib;

import com.kukso.hytale.lib.commands.CommandBootstrap;
import com.kukso.hytale.lib.config.ConfigManager;
...
public class Main extends JavaPlugin {
    ...
    protected void setup() {
        ...
        Path dataDir = Path.of("mods/KuksoLib");
